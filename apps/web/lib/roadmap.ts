...
export const NOOR_MASTER_ROADMAP = {
  ...
  futureSprints: [
    { sprint: 'Sprint 21', title: 'Quran production source selection gate', status: 'next', objective: 'Convert candidate placeholder into a real approved source record, or keep production import blocked with clear reasons.' },
    { sprint: 'Sprint 22', title: 'Tafseer importer adapter v1', status: 'future', objective: 'Normalize approved tafseer book data into NOOR CDN tafseer routes.' },
