...
const roadmap = {
  ...
  currentSprint: {
    ...
    status: 'current',
    objective: 'Create the first tafseer import adapter that normalizes a structured tafseer fixture into NOOR CDN-style tafseer routes while keeping production tafseer blocked until source approval is complete.'
  },
  completedSprints: [
    'Sprint 0','Sprint 1','Sprint 2','Sprint 3','Sprint 4','Sprint 5','Sprint 6','Sprint 7','Sprint 8','Sprint 9','Sprint 10','Sprint 11','Sprint 11.5','Sprint 12','Sprint 13','Sprint 14','Sprint 15','Sprint 16','Sprint 17','Sprint 18','Sprint 19','Sprint 20','Sprint 21'
  ],
  futureSprints: [
    { sprint: 'Sprint 23', title: 'Hadith importer adapter v1', status: 'next' },
  ...
  commands: ['pnpm roadmap:status', 'pnpm quran:gate', 'pnpm check:quran-source-gate', 'pnpm quran:import', 'pnpm check:quran-import', 'pnpm tafseer:import', 'pnpm check:tafseer-import', 'pnpm check:roadmap', 'pnpm check:pack']
};
...
console.log('NOOR Sprint 22 roadmap status generated.');
